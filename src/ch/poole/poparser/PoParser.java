 ...
 */
  ...
  final public String msgid() throws ParseException {
        String id = null;
  ...
  final public String msgstr() throws ParseException {
        String str = null;
    jj_consume_token(MSGSTR);
    str = string();
    if (jj_2_4(2)) {
      jj_consume_token(EOE);
    } else {
  ...
  final public PoEntry entry() throws ParseException {
        PoEntry entry = null;
        String id = null;
        String str = null;
    id = msgid();
  ...
  final public HashMap<String,String> getMap() throws ParseException {
  ...
  private boolean jj_3_4() {
    if (jj_scan_token(EOE)) return true;
    return false;
  }
  ...
  private boolean jj_3R_5() {
    if (jj_scan_token(MSGID)) return true;
