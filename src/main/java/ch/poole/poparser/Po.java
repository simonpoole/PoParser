...
public class Po implements Serializable {
    ...
    private Map<String, Map<String, String>> m = null;
    ...
    /**
     * Add strings where missing from a further file, can be called multiple times.
     * 
     * @param is
     * @throws ParseException
     */
    public void addFallback(InputStream is) throws ParseException {
        PoParser pp = new PoParser(is);
        Map<String, Map<String, String>> fallback = pp.getMap();
        for (Entry<String, Map<String, String>> entry : m.entrySet()) { // loop over contexts
    ...
    /**
     * Return the translation of a string or the string itself if no translation exists.
     * 
     * @param id
     * @return
     */
    ...
    /**
     * Return the translation of a string or the string itself if no translation exists, considering context.
     * 
     * @param id
     * @return
     */
